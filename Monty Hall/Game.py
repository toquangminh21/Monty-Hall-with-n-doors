...
Minh To
Thursday 5/29/2020
Exercises 6.1.3: Game class for Monte Carlo simulation
'''
...
class Game(object):
    def __init__(self, inputQ, outputQ, player=Player):
        self.player = player
        self.inputQ = inputQ
    ...
    def playGame(self, strategy, initialList, simulations):
        ...
        for i in range(simulations):
            ...
            # Loop through the remainingDoors and return the montyDoor in a list by removing ALL the non-prize goat doors.
            ...
            # 2nd approach loop: bugged somewhere though.
            ...
            finalDoor = self.player.strategy(strategy, newList)             # Will evaluate to initialDoor if strategy == "stay"
        ...
        # After the loop is over, we put the winCounter on the outputQ and aggregate the results in main() program'
        self.outputQ.put(winCounter)
        print('A process has finished')

        # If no Multiprocessing, print this out as summary
